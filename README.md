...
```javascript
import cps from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-berndt-cps-wages-1985@v0.2.3-deno/mod.js';
```
...
import dataset from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-berndt-cps-wages-1985@v0.2.3-deno/mod.js';
