...
```javascript
cps = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-berndt-cps-wages-1985@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-berndt-cps-wages-1985@umd/bundle.js"></script>
```
